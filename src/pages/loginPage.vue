<template>
  <q-page class="flex flex-center flex-col">
    ...
    <div class="border-2 border-rose-500 w-[400px] md:w-[600px]  my-5 rounded-lg bg-gray-50 shadow-4">
      ...
      <q-btn class="px-10 py-3 text-lg text-rose-500 hover:text-rose-600 shadow-lg shadow-rose-500/50 " outline rounded  label="login" />
    </div>
    </div>
    <div class="flex-col pt-8">
      <div class="text-xl">Yet not registered?</div>
      <div class="text-lg text-center">Go<span class="text-rose-500 text-bold cursor-pointer"> registration </span>page</div>
    </div>
